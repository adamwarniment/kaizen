        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0f]">
            ...
            >
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Kaizen</h1>
                    <p className="text-slate-400 mt-2">Level up your life, one goal at a time.</p>
                </div>
                ...
                <div className="mt-6 flex flex-col gap-4">
                    <button
                        onClick={handleDemo}
                        className="w-full py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl font-semibold transition-all"
                    >
                        Try Demo
                    </button>
